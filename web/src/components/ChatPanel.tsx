...
import type { AppMode, Message, ModelOption, SessionAttachment } from '../types'
...
export function ChatPanel(props: ChatPanelProps) {
  ...
  const inferenceSource = props.selectedModel === 'free' ? '本地推理' : '云端推理'
        ...
        <div className="messages-inner">
          {props.messages.length ? props.messages.map((message) => (
            ...
            <div className="empty-chat">
              ...
              <p>询问 AI、RAG、Agent 或上传你的 Markdown 学习笔记。</p>
            </div>
          )}
          {props.loading && (
